...
You should start by using the [starter code](starter_code/) and focus on adding the proper JavaScript to update the background of the page. Please create a new repository on GitHub called "homework-city" and push your code to it when you are ready to submit. 

I will evaluate your fulfillment of the technical requirements, and will provide a numeric grade on a scale for each technical requirement: does not meet expectations (0); meets expectations (1); exceeds expectations (2). 

The maximum possible score on this assignment is 28/28. Bonus materials are completely optional.

### Final Project Milestones

- By October 7th, you should have submitted a proposal and wireframes for your final project. 
- Milestone #2 ,  a draft of the HTML/CSS will be due on 10/14
